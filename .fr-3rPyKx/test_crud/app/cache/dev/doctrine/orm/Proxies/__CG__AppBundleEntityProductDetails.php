 ...
 */
class ProductDetails extends \AppBundle\Entity\ProductDetails implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ProductDetails' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ProductDetails' . "\0" . 'productDescription', '' . "\0" . 'AppBundle\\Entity\\ProductDetails' . "\0" . 'productPrice');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductDetails $proxy) {
