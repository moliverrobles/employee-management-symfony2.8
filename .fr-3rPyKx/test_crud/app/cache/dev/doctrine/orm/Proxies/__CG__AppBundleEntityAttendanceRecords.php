 ...
 */
class AttendanceRecords extends \AppBundle\Entity\AttendanceRecords implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\AttendanceRecords' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\AttendanceRecords' . "\0" . 'empId', '' . "\0" . 'AppBundle\\Entity\\AttendanceRecords' . "\0" . 'timeIn', '' . "\0" . 'AppBundle\\Entity\\AttendanceRecords' . "\0" . 'timeOut');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AttendanceRecords $proxy) {
